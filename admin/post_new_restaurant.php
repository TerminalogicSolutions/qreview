...
if(isset($_SESSION['authenticated_user']))
	{
		...
		$query = "Insert into restaurants (title, restaurant_text, fblink, date_posted) VALUES ('$title', '$restaurant_text', '$fblink', '$date')";
		$result = mysql_query($query );
		
		if ($result)
					{
						//Pull the last insert recid to be associated with the included images 		
						$querylast = "Select Last_Insert_ID() as recid from restaurants";

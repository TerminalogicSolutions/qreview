	...
	<?php 
		$queryProducts = "Select * from giveaways order by recid desc limit 0,4";
		...
		<tr align="center">
			...
			$rand = rand(1,1000);
				while($row = mysql_fetch_array($resultProducts, MYSQL_ASSOC))
					{
						echo "<td width=\"25%\">";
						echo "<a href=\"index.php?content=giveawaysdetail&id=" . $row['recid'] . "\">";
						echo "<strong>" . stripslashes($row['title']) . "</strong><br>";
							if(file_exists($defaultgiveawaysImageFolder . $row['recid']. "_1_sm.jpg"))
								{
									echo "<img src = \"" . $defaultgiveawaysImageFolder . $row['recid'] . "_1_sm.jpg?" . $rand . "\">";
								}
						echo "<br>";

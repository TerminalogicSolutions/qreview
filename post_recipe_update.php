...
if(isset($_SESSION['authenticated_user']))
	{
		...
		$query = "Update recipe SET title = '$title', rating = '$rating', recipe_text = '$recipe_text', fblink = '$fblink', category_recid = '$category_recid', date_posted = '" . date("Ymd") . "' where recid = $recid";
